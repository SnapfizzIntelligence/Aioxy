...
Output: aioxy_pef3.1_database.js
"""
...
def build_ilcd_registry(filepath):
    ...
    category_mapping = {
        ...
        'AQUATIC_ECO_TOXICITY': 'Ecotoxicity, freshwater',
        'RESPIRATORY_INORGANICS': 'EF-particulate matter',
        'AQUATIC_EUTROPHICATION': 'Eutrophication, freshwater',
        'TERRESTRIAL_EUTROPHICATION': 'Eutrophication, terrestrial',
        'CANCER_HUMAN_HEALT_EFFECTS': 'Human toxicity, cancer',
        'NON_CANCER_HUMAN_HEALT_EFFECTS': 'Human toxicity, non-cancer',
        'IONIZING_RADIATION': 'Ionising radiation',
        'LAND_USE': 'Land use',
        'OZONE_DEPLETION': 'Ozone depletion',
        'PHOTOCHEMICAL_OZONE_CREATION': 'Photochemical ozone formation',
        'ABIOTIC_RESOURCE_DEPLETION': 'Resource depletion, fossils',
        'OTHER': 'Water use'
    }
...
# ============================================================
# DATABASE 5: FAOSTAT Crop Yields
# ============================================================
