...
(function () {
    ...
    window.displaySupplyChainMap = function () {
        ...
        // 2. Guard: only render if at least one non-FR origin exists
        ...
        // Group ingredients by origin country
        const byCountry = {};
        ingredients.forEach(ing => {
            const code = ing.country || 'FR';
            if (!byCountry[code]) byCountry[code] = { count: 0, names: [], dqr: ing.dqr || 3 };
        ...
        Object.entries(byCountry).forEach(([code, data]) => {
            ...
            legendRows += `<tr>
                ...
                <td style="padding:4px 8px;color:#64748B;">${isEU ? 'EU' : 'Non-EU'}</td>
            </tr>`;
        });
                ...
                <table style="width:100%;border-collapse:collapse;font-size:0.85rem;">
                    <thead>
                        <tr style="background:#F8FAFC;border-bottom:1px solid var(--border);">
                            <th style="padding:6px 8px;text-align:left;color:var(--gray);">Country</th>
                            <th style="padding:6px 8px;text-align:left;color:var(--gray);">Ingredients</th>
                            <th style="padding:6px 8px;text-align:left;color:var(--gray);">Region</th>
                        </tr>
                    </thead>
