...
async function getAnswer(question) {
  ...
  // TECH INDUSTRY
  "semiconductor water risk": {
    answer: `<strong>Water Use in Chip Manufacturing</strong><br><br>
             💧 <u>Key Stats</u>:<br>
             • TSMC uses 156,000 tons/day (≈ 60 Olympic pools)<br>
             • Water stress risk in Arizona/Taiwan fabs<br><br>
             
             ♻️ <u>Mitigation</u>:<br>
             • 85% water recycling (Intel's standard)<br>
             • Zero-liquid-discharge systems<br><br>
             
             📜 <u>Regulation</u>:<br>
             • SEMI S23 water conservation standard`,
    sources: [
      "TSMC 2023 ESG Report p.47", 
      "Intel Water Policy",
      "SEMI S23 Standard"
    ]
  },
  ...
  "ev battery recycling": {
    answer: `<strong>Li-ion Battery Recovery</strong><br><br>
             🔋 <u>Current Rates</u>:<br>
             • 5% recycled (vs 99% lead-acid)<br>
             • 500,000 tons waste by 2030<br><br>
             
             🏭 <u>Solutions</u>:<br>
             • Tesla's closed-loop Nevada system<br>
             • Redwood Materials hydrometallurgy<br><br>
             
             📝 <u>Compliance</u>:<br>
             • EU Battery Regulation 2023`,
    sources: [
      "ICCT Battery Recycling Report", 
  ...
  // FINANCE
  "esg fund greenwashing": {
    answer: `<strong>SEC Greenwashing Rules</strong><br><br>
             💸 <u>2024 Requirements</u>:<br>
             • 100% disclosure of holdings<br>
             • Climate impact metrics<br>
             • Exclusion criteria transparency<br><br>
             
             ⚠️ <u>Penalties</u>:<br>
             • $2M fine on Deutsche Bank DWS (2023)<br>
             • BNP Paribas fund reclassification<br><br>
             
             ✅ <u>Best Practice</u>:<br>
             • SFDR Article 9 compliance`,
    sources: [
      "SEC Rule 35d-1", 
      "SFDR Level 2 Regulation",
      "Morningstar Greenwashing Study"
    ]
  },

  // COMPARATIVE ANALYSIS
  "apple vs tesla esg": {
    answer: `<strong>2024 Benchmark (Sustainalytics Data)</strong><br><br>
             🍎 <u>Apple</u>:<br>
             • Score: 22.3 (Low Risk)<br>
             • Strength: Supplier clean energy program<br>
             • Risk: Cobalt sourcing DRC<br><br>
             
             � <u>Tesla</u>:<br>
             • Score: 28.7 (Medium Risk)<br>
             • Strength: EV carbon avoidance<br>
             • Risk: Nickel mining deforestation<br><br>
             
             📊 <u>Key Difference</u>:<br>
             Apple leads in supply chain transparency,<br>
             Tesla wins in product impact`,
    sources: [
      "Sustainalytics 2024 Reports", 
      "Bloomberg ESG Comparative Analysis",
